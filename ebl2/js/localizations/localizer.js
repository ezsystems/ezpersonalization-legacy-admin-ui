...
function localizer() {
	...
	"en": { "login_welcometo": "Welcome to your Recommendation Service",
			...
			"login_pnp":"Free Plug and Play Recommendations",
			...
			"regstep3_background" : "Background color",
			...
			"reset_password_reset_your_password_text" : "We will send you an Email with a link to get a new one.",
			...
			"model_CF_I2I_MIX_BUY_BUY_title" : "Frequently bought together",
			"model_CF_I2I_MIX_BUY_BUY_description" : "Products that were frequently bought together in a bundle",
	...
	"de": {"login_welcometo": "Willkommen bei Ihrem Empfehlungsdienst",
		 	...
		 	"login_pnp":"Kostenlose Plug and Play Empfehlungen",
			...
			"regstep3_background" : "Hintergrundfarbe",
			...
			"reset_password_reset_your_password_text" : "Eine Email mit dem Link zur Passwortänderung wird Ihnen umgehend zugesandt.",
			"reset_password_email" : "Email:",
			"reset_password_send" : "Senden",
			"reset_password_close" : "Schließen",
			...
			"model_CF_I2I_MIX_CLICK_BUY_profile_title" : "Ultimately bought",
			"model_CF_I2I_MIX_BUY_BUY_title" : "Frequently bought together",
			"model_CF_I2I_MIX_BUY_BUY_description" : "Produkte, die oft zusammen bzw. im Bundle gekauft werden",
			"model_CF_I2I_MIX_CLICK_CONSUME_profile_title" : "Ultimately consumed",
			"model_POPULARITY_LONG_CLICK_profile_title" : "Top clicked",
			"model_POPULARITY_LONG_CONSUME_profile_title" : "Top consumed",
			"model_POPULARITY_LONG_BUY_profile_title" : "Top purchased",
	...
	"fr": { "login_welcometo": "Bienvenus sur votre service de Recommandation (optimisé pour Mozilla Firefox)",
			...
			"login_pnp":"Plug and Play recommendations gratuites",
			...
			"regstep1_licence_and_legal_information" : 'You are only a few steps away from your free trial YOOCHOOSE Recommender Engine. Before you create an account, we request your attention for some legal issues. We take data protection and privacy issues very seriously and ask you to carefully read the following instructions and align the data protection information in your website accordingly. You may also <a href="/dataprivacy.pdf" class="pdf">view and download the PDF version',
			...
			"regstep3_background" : "La couleur de fond",
			...
			"reset_password_reset_your_password_text" : "Vous recevrez un e-mail contenant un lien afin d'en obtenir un nouveau.",
			"reset_password_email" : "E-mail :",
			"reset_password_send" : "Envoyer",
			"reset_password_close" : "Fermer",
			...
			"model_CF_I2I_MIX_CLICK_BUY_profile_title" : "Ultimately bought",
			"model_CF_I2I_MIX_BUY_BUY_title" : "Fréquemment achetés ensemble",
			"model_CF_I2I_MIX_BUY_BUY_description" : "Les produits qui ont été souvent acheté ensemble dans un paquet",
			"model_CF_I2I_MIX_CLICK_CONSUME_profile_title" : "Ultimately consumed",
