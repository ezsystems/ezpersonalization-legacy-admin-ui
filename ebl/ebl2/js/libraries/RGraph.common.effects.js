    ...
    */
    RGraph.Effects.Rose.Grow = function (obj)
    {
        ...
        RGraph.Effects.Animate(obj, {'chart.margin': original_margin, 'chart.animation.grow.factor': 1}, arguments[2]);
    }
    ...
    */
    RGraph.Effects.Odo.Grow = function (obj)
    {
        ...
        obj.Set('chart.value', obj.start);

        RGraph.Effects.Animate(obj, {'chart.value': original_value}, arguments[2]);
        
        setTimeout(function () {obj.Set('chart.value', original_value); RGraph.Clear(obj.canvas);obj.Draw();}, 1000);
    }
